...
public class GUI_Frame extends JFrame{
	...
	private JButton				count_s				= new JButton("递归调查");
	...
	private void initEventListeners(){
		...
		count_s.addActionListener(this::countS);
	...
	private void countS(ActionEvent event){
		Type = 6;
		CountStart();
	}
